...
namespace UnityStandardAssets.Cameras
{
    public class FreeLookCam : PivotBasedCameraRig
    {
        ...
        private Quaternion tempTransformQua;
        ...
        private void OnEnable()
        {
            ...
            tempTransformQua = transform.localRotation;
            // m_TiltAngle = m_TransformTargetRot.eulerAngles.x;
        }
        ...
        private void HandleRotationMovement()
        {
           ...
           // m_LookAngle=m_LookAngle+m_TransformTargetRot.eulerAngles.y;
          ...
          m_PivotTargetRot=Quaternion.Euler(tempTransformQua.eulerAngles.x+ m_TiltAngle, m_PivotEulers.y, m_PivotEulers.z);
